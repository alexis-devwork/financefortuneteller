...
class Card:
    ...
    EMO_DICT = {
        'of':'',
        'of ':'of',
        'Ace':'\U0001F1E6\U00002728'.encode('utf-8').decode('utf-8'),
        ...
        'Page':'\U0001F1F5\U00002728'.encode('utf-8').decode('utf-8'),
        'Knight':'\U0001F1F0\U00002728'.encode('utf-8').decode('utf-8'),
